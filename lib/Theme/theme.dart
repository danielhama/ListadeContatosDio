...
abstract class ThemeCustom {
  ...
  static ThemeCustom of(BuildContext context) {
...
class LightModeTheme extends ThemeCustom {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0x35757575);
  ...
  late Color grayIcon = Color(0x80090F13);
...
class DarkModeTheme extends ThemeCustom {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
  ...
  late Color primary = const Color(0x35757575);
  late Color secondary = const Color(0xFF590219);
  late Color tertiary = const Color(0xFF181617);
  late Color alternate = const Color(0xFFADB6BC);
  ...
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF616161);
  late Color accent2 = const Color(0xFF616161);
  late Color accent3 = const Color(0xFFE0E0E0);
  late Color accent4 = const Color(0xFFEEEEEE);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFFCDC0C);
